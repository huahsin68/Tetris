...
TetriminoO::TetriminoO() : Tetrimino()
{
	...
	Position twoBlock1(0, 0);
	Position twoBlock2(0, 0);
	Position twoBlock3(0, 0);
	Position twoBlock4(0, 0);
	...
	Position threeBlock1(0, 0);
	Position threeBlock2(0, 0);
	Position threeBlock3(0, 0);
	Position threeBlock4(0, 0);
	...
	Position fourBlock1(0, 0);
	Position fourBlock2(0, 0);
	Position fourBlock3(0, 0);
	Position fourBlock4(0, 0);
...
TetriminoO::TetriminoO(GameLevel* gameLevel) : TetriminoO()
{
...
bool TetriminoO::create(unsigned int shader)
{
	bool ret = true;
	GameObject* block = nullptr;

	float renderPosY = 0.f - (BLOCK_HEIGHT * 4);
